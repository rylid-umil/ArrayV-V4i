...
SortPrompt.setSortThreadForCategory('Impractical Sorts', 29) {
    run BadSort go 64.numbers, 0.0075.speed
    run RodSort go 64.numbers, 0.0055.speed
    ...
    run BosoSort go 6.numbers, 1e-9.speed
    run BomoSort go 6.numbers, 1e-9.speed
    run BovoSort go 6.numbers, 1e-9.speed
