...
Min heap but modify to match highlights shown in Worthy's videos (mainly 16 sorts - color circle), this sort not included in worthy's originl videos but wahtever
 *
 */

public final class LegacyMinHeapSort extends Sort {
    public LegacyMinHeapSort(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);

        this.setSortListName("Legacy Min Heap");
        this.setRunAllSortsName("Min Heap Sort");
        this.setRunSortName("Legacy Min Heap Sort");
