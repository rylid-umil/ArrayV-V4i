...
/**
 *
selection sort but *✨MAGICAL✨* ‼️🦅🦅😰🍳💥🍳🧪🧪🧪🧪 and BETTER
 *
 */
public final class OptimizedMagicSelectionSort extends Sort {
    public OptimizedMagicSelectionSort(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);

        this.setSortListName("Optimized Magic Selection");
        this.setRunAllSortsName("Optimized Magic Selection Sort");
        this.setRunSortName("Optimized Magic Selection Sort");
